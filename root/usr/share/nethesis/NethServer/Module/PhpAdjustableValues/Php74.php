...
/**
 * Implement gui module for php74 settings
 */

class Php74 extends \Nethgui\Controller\AbstractController
{
    ...
    $this->declareParameter('AllowUrlFopen', $this->createValidator()->memberOf('On','Off'), array('configuration', 'php74', 'AllowUrlFopen'));
    $this->declareParameter('MaxExecutionTime',  $executiontime , array('configuration', 'php74', 'MaxExecutionTime'));
    $this->declareParameter('MemoryLimit', Validate::POSITIVE_INTEGER, array('configuration', 'php74', 'MemoryLimit'));
    $this->declareParameter('PostMaxSize', Validate::POSITIVE_INTEGER, array('configuration', 'php74', 'PostMaxSize'));
    $this->declareParameter('UploadMaxFilesize', Validate::POSITIVE_INTEGER, array('configuration', 'php74', 'UploadMaxFilesize'));
    $this->declareParameter('MaxFileUpload', Validate::POSITIVE_INTEGER , array('configuration', 'php74', 'MaxFileUpload'));
    $this->declareParameter('MaxInputTime',  $inputtime , array('configuration', 'php74', 'MaxInputTime'));
