...
/**
 * Implement gui module for php72 settings
 */

class Php72 extends \Nethgui\Controller\AbstractController
{
    ...
    $this->declareParameter('AllowUrlFopen', $this->createValidator()->memberOf('On','Off'), array('configuration', 'php72', 'AllowUrlFopen'));
    $this->declareParameter('MaxExecutionTime',  $executiontime , array('configuration', 'php72', 'MaxExecutionTime'));
    $this->declareParameter('MemoryLimit', Validate::POSITIVE_INTEGER, array('configuration', 'php72', 'MemoryLimit'));
    $this->declareParameter('PostMaxSize', Validate::POSITIVE_INTEGER, array('configuration', 'php72', 'PostMaxSize'));
    $this->declareParameter('UploadMaxFilesize', Validate::POSITIVE_INTEGER, array('configuration', 'php72', 'UploadMaxFilesize'));
    $this->declareParameter('MaxFileUpload', Validate::POSITIVE_INTEGER , array('configuration', 'php72', 'MaxFileUpload'));
    $this->declareParameter('MaxInputTime',  $inputtime , array('configuration', 'php72', 'MaxInputTime'));
