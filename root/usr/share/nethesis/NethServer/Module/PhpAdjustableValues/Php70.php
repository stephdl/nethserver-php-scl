...
class Php70 extends \Nethgui\Controller\AbstractController
{
    ...
    $this->declareParameter('AllowUrlFopen', $this->createValidator()->memberOf('On','Off'), array('configuration', 'php70', 'AllowUrlFopen'));
    $this->declareParameter('MaxExecutionTime',  $executiontime , array('configuration', 'php70', 'MaxExecutionTime'));
    $this->declareParameter('MemoryLimit', Validate::POSITIVE_INTEGER, array('configuration', 'php70', 'MemoryLimit'));
    $this->declareParameter('PostMaxSize', Validate::POSITIVE_INTEGER, array('configuration', 'php70', 'PostMaxSize'));
    $this->declareParameter('UploadMaxFilesize', Validate::POSITIVE_INTEGER, array('configuration', 'php70', 'UploadMaxFilesize'));
    $this->declareParameter('MaxFileUpload', Validate::POSITIVE_INTEGER , array('configuration', 'php70', 'MaxFileUpload'));
    $this->declareParameter('MaxInputTime',  $inputtime , array('configuration', 'php70', 'MaxInputTime'));
   ...
   public function validate(\Nethgui\Controller\ValidationReportInterface $report)
    {
        ...
        elseif  ($this->parameters['MemoryLimit'] < $this->parameters['PostMaxSize']) {
            $report->addValidationErrorMessage($this, 'php70MemoryLimit', 'MemoryLimitLabelMustBeSuperiorThanPostMaxSize');
        }
        elseif  ($this->parameters['PostMaxSize'] < $this->parameters['UploadMaxFilesize']) {
            $report->addValidationErrorMessage($this, 'php70PostMaxSize', 'PostMaxSizeMustBeSuperiorThanUpMaxFileSize');
        }
