...
class Php55 extends \Nethgui\Controller\AbstractController
{
    ...
    $this->declareParameter('AllowUrlFopen', $this->createValidator()->memberOf('On','Off'), array('configuration', 'php55', 'AllowUrlFopen'));
    $this->declareParameter('MaxExecutionTime',  $executiontime , array('configuration', 'php55', 'MaxExecutionTime'));
    ...
    $this->declareParameter('MaxFileUploads', Validate::POSITIVE_INTEGER , array('configuration', 'php55', 'UploadMaxFilesize'));
   ...
   public function validate(\Nethgui\Controller\ValidationReportInterface $report)
    {
        ...
        elseif  ($this->parameters['MemoryLimit'] < $this->parameters['PostMaxSize']) {
            $report->addValidationErrorMessage($this, 'Php55MemoryLimit', 'MemoryLimitLabelMustBeSuperiorThanPostMaxSize');
        }
        elseif  ($this->parameters['PostMaxSize'] < $this->parameters['UploadMaxFilesize']) {
            $report->addValidationErrorMessage($this, 'Php55PostMaxSize', 'PostMaxSizeMustBeSuperiorThanUpMaxFileSize');
        }
